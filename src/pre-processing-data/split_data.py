...
train_data.to_csv('data/result/pre-processing-data/split-data/training_data.csv', index=False)

# Menyimpan dataset validation ke file CSV
val_data.to_csv('data/result/pre-processing-data/split-data/validation_data.csv', index=False)
